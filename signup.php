    ...
    <div class="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
      <div class="sm:w-1/2 xl:w-3/5 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative"
        ...
        <div class="w-full  max-w-md z-10">
          <div class="sm:text-4xl xl:text-5xl font-bold leading-tight mb-6">Signup to access your account</div>
        ...
        <div class="max-w-md w-full space-y-8">
          <div class="text-center">
            <h2 class="mt-6 text-3xl font-bold text-gray-900">
              Welcome To Hyperstream!
            </h2>
            <p class="mt-2 text-sm text-gray-500">Please signup here</p>
          </div>
          <form class="mt-8 space-y-6" action="" method="POST">
            <div class="relative">
              ...
              <input name="name"
                ...
                type="text" placeholder="Your name here" value="<?php echo isset($_POST['name']) ? $_POST['name'] : null ?>">
            </div>
            <div class="mt-8 content-center">
              ...
              <input name="email"
                ...
                type="email" placeholder="test@domain.com" value="<?php echo isset($_POST['email']) ? $_POST['email'] : null ?>">
            </div>
            <div class="mt-8 content-center">
              <label class="ml-3 text-sm font-bold text-gray-700 tracking-wide">
                Phone
              ...
              <input name="phone"
                class="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-indigo-500"
                type="number" placeholder="Enter your password" value="<?php echo isset($_POST['phone']) ? $_POST['phone'] : null ?>">
            </div>
             <div class="mt-8 content-center">
              <label class="ml-3 text-sm font-bold text-gray-700 tracking-wide">
                Password
            ...
            <p class="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
              <span>Already have an account? <a href="./" class="text-indigo-400 hover:text-blue-500 no-underline hover:underline cursor-pointer transition ease-in duration-300">Login here</a></span>
            </p><br>
